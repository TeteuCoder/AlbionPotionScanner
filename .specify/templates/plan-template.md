...
- Result data must expose item name, sell price, ingredient cost, crafting fee, marketplace tax,
  Material Return Rate, total cost, profit, and ROI.
- Support for food, bags, weapons, or armor requires a new specification.
- Python type hints, PEP 8, and single-responsibility functions remain mandatory.
